...
*
*后台添加排行榜功能
* 比如金币查询    按时间查询  当天查询 为  查询当天谁的金币最多   每个小时  储蓄一次
* 查询元宝和金币来源明细  个人金币排行榜 元宝排行榜  玫瑰排行榜 核弹排行榜  充值排行榜
* 游戏内赢取金币排行榜  在线时间排行榜
*
*特殊道具  核弹使用情况  点击总兑换数量 每页显示 200个   总赠送数量 每页展示30个  总使用数量 每页展示50量 总剩余数量 每页显示100个
* 需要展示信息 为 用户信息  时间 兑换时间  受赠人 数量 使用时间
*
*玫瑰花数据汇总参考核弹模板
*
*
*邮件系统添加发送VIP等级 以上发送  和 道具需要添加  元宝 核弹 玫瑰 金币 房卡 参赛卷
*
*
*
*
